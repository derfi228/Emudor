...
private:
    ...
    // Аппаратный умножитель PPU: M7A (16 бит со знаком) × последний байт $211C
    // (8 бит со знаком). Результат 24 бита — читается из $2134-$2136 (MPYL/M/H).
    // Многие игры (Zelda ALTTP и др.) используют его для быстрой математики.
    int8_t   m7MulB_ = 0;           // последний байт, записанный в $211C
