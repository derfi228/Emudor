...
9\. Если в очереди test\_runs мало ROM-ов (меньше 10 с result='pending') — вызови `rom\_hunter` чтобы пополнить запас тестовых ROM-ов для текущей консоли.
