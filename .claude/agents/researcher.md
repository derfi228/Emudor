...
Получаешь issue\_id из базы данных или конкретный технический вопрос.
...
5\. Запиши результат в `agent\_data\\research\\issue\_<ID>.md` с указанием источников и URL
